...
tidy:
	@echo $(SKEL) > .tmp.cc
	clang-tidy --header-filter=./ -checks='+*,-clang-analyzer-optin.performance.Padding' .tmp.cc -- -std=c++11 -I$(COMANCHE_HOME)/src/lib/common/include -I$(COMANCHE_HOME)/src/lib/core/include $(SYSTEM_INCLUDES) 
