...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    desc.add_options()("help", "Show help")(
        ...
        "data-dir", po::value<std::string>()->default_value(DEFAULT_PMEM_DIR),
        "Data directory")("forced-exit", "Forced exit")(
        "device", po::value<std::string>()->default_value("mlx5_0"),
        "Network device (e.g., mlx5_0)")(
        "fabric-provider", po::value<std::string>()->default_value("verbs"),
        "Fabric provider")("backend",
                           po::value<std::string>()->default_value("mapstore"),
                           "Back-end component")(
