...
#ifndef __COMANCHE_POLICY_LOCAL_H__
#define __COMANCHE_POLICY_LOCAL_H__
...
/** 
 * Basic policy for local-only device
 * 
 */
class Policy_local : public Policy
{
public:
  
  Policy_local(Storage_device * storage_device);

  virtual ~Policy_local();
  ...
  /** 
   * Get virtual address of IO buffer
   * 
   * @param io_mem IO memory handle
   * 
   * @return virtual address
   */
  void * get_addr(io_memory_t io_mem);
...
#endif //__COMANCHE_POLICY_LOCAL_H__
