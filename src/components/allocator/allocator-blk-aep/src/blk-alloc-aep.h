...
class Block_allocator_AEP : public Component::IBlock_allocator {
 ...
 public:
   ...
   * @param id  the id for this specific allocator, this should be prefixed with
   * the actual kvstore pool name
   *
   * this is a persistent block allocator, if the id already exist, it will try
   * to reuse the mapping information
   *
   */
   ...
   */
  DECLARE_VERSION(0.1);
  DECLARE_COMPONENT_UUID(0x7f23a368,
                         0x1993,
                         0x488b,
                         0x95cf,
                         0x8c,
...
class Block_allocator_AEP_factory : public Component::IBlock_allocator_factory {
 public:
   ...
   */
  DECLARE_VERSION(0.1);
  DECLARE_COMPONENT_UUID(0xfac3a368,
                         0x1993,
                         0x488b,
                         0x95cf,
                         0x8c,
  ...
  {
    {
      Component::IBlock_allocator* obj =
          static_cast<Component::IBlock_allocator*>(new Block_allocator_AEP(
              max_lba, path, name, numa_node, force_init));
