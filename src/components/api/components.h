...
/*< kvstore */
DECLARE_STATIC_COMPONENT_UUID(kvstore, 0x59564581,0x9e1b,0x4811,0xbdb2,0x19,0x57,0xa0,0xa6,0x84,0x57);
DECLARE_STATIC_COMPONENT_UUID(kvstore_factory, 0xfac64581,0x9e1b,0x4811,0xbdb2,0x19,0x57,0xa0,0xa6,0x84,0x57);
