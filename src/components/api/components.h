...
/*< ramrbtree index*/
DECLARE_STATIC_COMPONENT_UUID(ramrbtree,0x8a120985,0x1253,0x404d,0x94d7,0x77,0x92,0x75,0x21,0xa1,0x29);
DECLARE_STATIC_COMPONENT_UUID(ramrbtree_factory, 0xfac20985,0x1253,0x404d,0x94d7,0x77,0x92,0x75,0x21,0xa1,0x29);
