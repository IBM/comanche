...
const unsigned KVStore_test::estimated_object_count = pmem_force ? estimated_object_count_large : estimated_object_count_small;

constexpr unsigned KVStore_test::many_key_length;
constexpr unsigned KVStore_test::many_value_length;

const unsigned KVStore_test::many_count_target = pmem_force ? many_count_target_large : many_count_target_small;
unsigned KVStore_test::many_count_actual;
