...
Fabric_server_grouped_factory::Fabric_server_grouped_factory(Fabric &fabric_, event_producer &eq_, ::fi_info &info_, std::uint16_t port_)
...
Component::IFabric_server_grouped * Fabric_server_grouped_factory::get_new_connections()
{
