  ...
  , private boost::noncopyable
{
  ...
  void listener(Component::IFabric_server_grouped_factory &ep);

public:
  remote_memory_server_grouped(Component::IFabric &fabric, const std::string &fabric_spec, std::uint16_t control_port);
