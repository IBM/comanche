...
/* Sample's Logic */
doca_error_t aes_gcm_decrypt(struct aes_gcm_cfg *cfg, char *file_data, size_t file_size, FILE *out_file);
...
main(int argc, char **argv)
{
	...
	size_t offset = 0;
    size_t buffer_size = 0; // Define this based on your constraints
    FILE *out_file = NULL;
    ...
    while (offset < file_size) {
        ...
        result = aes_gcm_decrypt(&aes_gcm_cfg, file_data + offset, current_chunk_size, out_file);
        if (result != DOCA_SUCCESS) {
