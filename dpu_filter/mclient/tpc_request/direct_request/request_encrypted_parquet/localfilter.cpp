...
int main() {
    ...
    const std::string sqlExpression = "SELECT COUNT(*), SUM(inv_quantity_on_hand) FROM S3Object WHERE inv_item_sk BETWEEN 13 AND 299982 AND inv_date_sk BETWEEN 2451654 AND 2451714";
